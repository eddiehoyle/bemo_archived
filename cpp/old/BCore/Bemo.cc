...
#include <old/BCore/managers/GraphManager.hh>
#include <old/BCore/managers/PluginManager.hh>
#include <old/BCore/managers/ObjectManager.hh>
#include <old/BCore/managers/ConnectionManager.hh>

#include <old/BCore/system/PluginSystem.hh>
#include <old/BCore/system/NodeSystem.hh>
#include <old/BCore/event/EventHandler.hh>

#include <old/BCore/dag/DagManager.hh>

#include <old/BCore/util/Log.hh>
#include <old/BCore/node/MultiplyNode.hh>
